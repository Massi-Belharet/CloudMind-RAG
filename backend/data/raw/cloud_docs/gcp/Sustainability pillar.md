> [!IMPORTANT]
> This page provides a one-page view of all of the pages in the sustainability pillar of the [Well-Architected Framework](https://docs.cloud.google.com/architecture/framework/sustainability). You can print this page or save it in PDF format by using your browser's print function.
>
...
As mentioned in
[Follow the 4Ms best practices for resource selection](https://docs.cloud.google.com/architecture/framework/sustainability/printable#resource-selection-best-practices), choose processors
...
- [Minimize computational work](https://docs.cloud.google.com/architecture/framework/sustainability/printable#minimal-computations): Favor lean, focused code that eliminates redundant logic and avoids unnecessary computations or feature bloat.
- [Use efficient algorithms and data structures](https://docs.cloud.google.com/architecture/framework/sustainability/printable#efficient-algorithms): Choose time-efficient and memory-efficient algorithms that reduce CPU load and minimize memory usage.
- [Optimize compute and data operations](https://docs.cloud.google.com/architecture/framework/sustainability/printable#optimized-operations): Develop with the goal of efficiently using all of the available resources, including CPU, memory, disk I/O, and network. For example, when you replace busy loops with event-driven logic, you avoid unnecessary polling.
- [Implement frontend optimization](https://docs.cloud.google.com/architecture/framework/sustainability/printable#optimized-frontend): To reduce the power that's consumed by end-user devices, use strategies like minimization, compression, and [lazy-loading](https://en.wikipedia.org/wiki/Lazy_loading) for images and assets.
...
- [Phase 1: Establish a baseline](https://docs.cloud.google.com/architecture/framework/sustainability/printable#establish-baseline)
- [Phase 2: Identify hotspots](https://docs.cloud.google.com/architecture/framework/sustainability/printable#identify-hotspots)
- [Phase 3: Implement targeted optimization](https://docs.cloud.google.com/architecture/framework/sustainability/printable#optimize)
- [Phase 4: Institutionalize sustainability practices and reporting](https://docs.cloud.google.com/architecture/framework/sustainability/printable#institutionalize)
...
- [W3C Web Sustainability Guidelines](https://docs.cloud.google.com/architecture/framework/sustainability/printable#ws-guidelines)
- [Green Software Foundation](https://docs.cloud.google.com/architecture/framework/sustainability/printable#gsg-guidelines)
- [Greenhouse Gas Protocol](https://docs.cloud.google.com/architecture/framework/sustainability/printable#ghg-protocol)
