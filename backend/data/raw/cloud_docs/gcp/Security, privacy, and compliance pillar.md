> [!IMPORTANT]
> This page provides a one-page view of all of the pages in the security, privacy, and compliance pillar of the [Well-Architected Framework](https://docs.cloud.google.com/architecture/framework). You can print this page or save it in PDF format by using your browser's print function.
>
...
[focus areas of cloud security](https://docs.cloud.google.com/architecture/framework/security/printable#focus_areas_of_cloud_security)
...
- [Choose system components that help to secure your workloads](https://docs.cloud.google.com/architecture/framework/security/printable#choose-system-components)
- [Build a layered security approach](https://docs.cloud.google.com/architecture/framework/security/printable#build_a_layered_security_approach)
- [Use hardened and attested infrastructure and services](https://docs.cloud.google.com/architecture/framework/security/printable#use_hardened_and_attested_infrastructure_and_services)
- [Encrypt data at rest and in transit](https://docs.cloud.google.com/architecture/framework/security/printable#encrypt_data_at_rest_and_in_transit)
...
- [Secure your network](https://docs.cloud.google.com/architecture/framework/security/printable#secure_your_network)
- [Verify every access attempt explicitly](https://docs.cloud.google.com/architecture/framework/security/printable#verify_every_access_attempt_explicitly)
- [Monitor and maintain your network](https://docs.cloud.google.com/architecture/framework/security/printable#monitor_and_maintain_your_network)
...
- [Adopt preventive security controls](https://docs.cloud.google.com/architecture/framework/security/printable#adopt_preventive_security_controls)
- [Automate provisioning and management of cloud resources](https://docs.cloud.google.com/architecture/framework/security/printable#automate_provisioning_and_management_of_cloud_resources)
- [Automate secure application releases](https://docs.cloud.google.com/architecture/framework/security/printable#automate_secure_application_releases)
- [Ensure that application deployments follow approved processes](https://docs.cloud.google.com/architecture/framework/security/printable#ensure_that_application_deployments_follow_approved_processes)
- [Scan for known vulnerabilities before application deployment](https://docs.cloud.google.com/architecture/framework/security/printable#scan_for_known_vulnerabilities_before_application_deployment)
- [Monitor your application code for known vulnerabilities](https://docs.cloud.google.com/architecture/framework/security/printable#monitor_your_application_code_for_known_vulnerabilities)
...
- [Integrate the functions of cyber defense](https://docs.cloud.google.com/architecture/framework/security/printable#integrate_the_functions_of_cyber_defense)
- [Use the Intelligence function in all aspects of cyber defense](https://docs.cloud.google.com/architecture/framework/security/printable#use_intelligence_in_all_aspects_of_cyber_defense)
- [Understand and capitalize on your defender's advantage](https://docs.cloud.google.com/architecture/framework/security/printable#understand_and_capitalize_on_your_defenders_advantage)
- [Validate and improve your defenses continuously](https://docs.cloud.google.com/architecture/framework/security/printable#validate_and_improve_your_defenses_continuously)
- [Manage and coordinate cyber-defense efforts](https://docs.cloud.google.com/architecture/framework/security/printable#manage_and_coordinate_cyber-defense_efforts)
...
- [Recommendations to use AI securely](https://docs.cloud.google.com/architecture/framework/security/printable#recommendations_to_use_ai_securely)
- [Recommendations for AI governance](https://docs.cloud.google.com/architecture/framework/security/printable#recommendations_for_ai_governance)
...
[levels of security autonomy](https://docs.cloud.google.com/architecture/framework/security/printable#levels_of_security_autonomy).

- [Enhance threat detection and response with AI](https://docs.cloud.google.com/architecture/framework/security/printable#enhance_threat_detection_and_response_with_ai)
- [Simplify security for experts and non-experts](https://docs.cloud.google.com/architecture/framework/security/printable#simplify_security_for_experts_and_non-experts)
- [Automate time-consuming security tasks with AI](https://docs.cloud.google.com/architecture/framework/security/printable#automate_time-consuming_security_tasks_with_ai)
- [Incorporate AI into risk management and governance processes](https://docs.cloud.google.com/architecture/framework/security/printable#incorporate_ai_into_risk_management_and_governance_processes)
- [Implement secure development practices for AI systems](https://docs.cloud.google.com/architecture/framework/security/printable#implement_secure_development_practices_for_ai_systems)
...
- [Recommendations to address organizational risks](https://docs.cloud.google.com/architecture/framework/security/printable#recommendations_to_address_organizational_risks)
- [Recommendations to address regulatory and compliance obligations](https://docs.cloud.google.com/architecture/framework/security/printable#recommendations_to_address_regulatory_and_compliance_obligations)
- [Recommendations to manage your data sovereignty](https://docs.cloud.google.com/architecture/framework/security/printable#recommendations_to_manage_your_data_sovereignty)
- [Recommendations to address privacy requirements](https://docs.cloud.google.com/architecture/framework/security/printable#recommendations_to_address_privacy_requirements)
...
|---|---|
| FedRAMP | - [Google Cloud FedRAMP implementation guide](https://docs.cloud.google.com/architecture/fedramp-implementation-guide) - [Setting up a FedRAMP Aligned Three-Tier Workload on Google Cloud](https://services.google.com/fh/files/misc/fedramp_aligned_workload_solution_guide.pdf) |
